            ...
            <div className="top_gnb">
                    ...
                    <div className="mo_menu">
                        <ul className="content_menu">
                            <li className="active"><Link to="mypage.html"><span><img src="image/settings.png" /></span><p>회원정보 변경</p></Link></li>
                            <li><Link to="image_up.html"><span><img src="image/image01.png" /></span><p>이미지</p></Link>
                    ...
                    <div className="member">
                        {userData.login ? (
                            ...
                            <div className="username">Username
                                <div className="member_logout"><Link to="/logout">로그아웃</Link></div>
                            </div>
                            </>
                        ): (
                            <>
                ...
                <div className="side_gnb">
                    ...
                    <ul className="content_menu">
                        <li className="active"><Link to="#"><span><img src="image/settings.png" /></span><p>회원정보 변경</p></Link></li>
                        <li><Link to="image_up.html"><span><img src="image/image01.png" /></span><p>이미지</p></Link>
                            <ul className="content_menu_sub">
